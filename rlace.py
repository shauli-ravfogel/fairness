...
EVAL_CLF_PARAMS = {"loss": "log", "tol": 0.1*1e-4, "iters_no_change": 50, "alpha": 1e-4, "max_iter": 200000}
NUM_CLFS_IN_EVAL = 15 # change to 1 for large dataset / high dimensionality
